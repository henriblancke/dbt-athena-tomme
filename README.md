...
| lf_tags | Lake Formation tag to assign to a database on creation. Must be a comma separated string of format: `tag_key=tag_value,tag_key2=tag_value2`. LF-tags can be used to manage data access within an organization. | Optional   | `department=finance`        |
...
* `lf_tags` (`default=none`)
  * Lake Formation tag to assign to a table on creation. Must be a comma separated string of format: `tag_key=tag_value,tag_key2=tag_value2`. LF-tags can be used to manage data access within an organization.
